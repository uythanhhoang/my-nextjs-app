...
import RoundOf16List from "@/components/RoundOf16List";
  ...
  return (
    <main className="min-h-screen bg-slate-900 p-8 text-white">
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-3xl font-bold">🔥 Vòng 16 đội — World Cup 2026</h1>
      ...
      {error ? (
        ...
        <RoundOf16List initialMatches={(matches ?? []) as unknown as MatchRow[]} />
      )}
    </main>
  );
}
